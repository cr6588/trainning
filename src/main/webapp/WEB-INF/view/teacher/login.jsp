...
<body>
    ...
    <div style="margin: 0 auto;width: 978px;"><h2>教师用户</h2></div>
    <div style="margin: 0 auto;width: 978px;height: 479px;border: 1px solid #EAEAEA;box-shadow: 0px 0px 2px 2px #aaaaaa;">
        <div class="left">
            <h3>登录以管理您的帐号</h3>
            <p>要查看和修改您的帐户信息，请登录。如果您还没有帐号，您可以 <a href="/teacher/register">立即创建一个。</a>
            </p>
        </div>
        <div class="right">
            <h3>登录</h3>
            <form id="form">
            <input class="input" name="username" id="username" placeholder="您的用户名" value="admin"><br>
            <input class="input" type="password" name="password" id="password" placeholder="密码" value="1">
            </form>
