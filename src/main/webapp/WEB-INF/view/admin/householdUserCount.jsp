...
function display(){
    ...
    $.post("/admin/getNewAddNum",{table: 'household', date:date}, function (result) {
        dataNum = result;
        ...
        if(result.length > 0){
            $('#container').highcharts({
                ...
                title: {
                    text: result[0].date.substr(0,4) + "年" + result[0].date.substr(5,2) + '月每天新增家长用户'
                },
                subtitle: {
                ...
                tooltip: {
                    formatter: function() {
                        return  month + '月' + this.x +'日<br>'+this.y+"人";
                    },
