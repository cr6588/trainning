            ...
            jump: function(e){ //触发分页后的回调
                $.get('/getCourseByPage', {page: e.curr,
                    ...
                    for(var i = 0; i < res.rows.length; i++) {
                        ...
                        htmlStr += "<td class='t3' style='width: 96px'>" + item.personNum + "人预约</td>";
                        htmlStr += "<td class='w-30'><input type='button' value='禁止' class='button orange medium' onclick='stopCourse(this," + item.id + ")'></td>";
                        htmlStr += "</tr>"
                    }
                    htmlStr += "</table>";
...
var rejectObject;
var rejectId;
function stopCourse(obj,id){
    rejectObject = obj;
    rejectId = id;
    layer.confirm('确定禁止该条课程信息吗？', {icon: 4}, function(index){
        layer.close(index);
        layer.open({
            type: 2,
            area: ['335px', '91px'],
