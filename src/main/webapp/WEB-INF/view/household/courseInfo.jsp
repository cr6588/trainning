    ...
    <div style="height: 280px;">
        ...
        <!--                 小类有可能为空比如游泳中的小类 -->
            ...
            <div class="yuyuebox">
                ...
                <div class="yu_bnt clearfix">
                    <p class="bnt-l">1.拨打电话，沟通细节
                        <b class="phone">${course.teacher.phone }</b>
                    </p>
                    <p class="bnt-r">2.沟通达成一致，登记预约
                    <input type="button" id="preBook" value="在线预约" class="button orange medium" >
                    </p>
                </div>
            </div>
        </div>
