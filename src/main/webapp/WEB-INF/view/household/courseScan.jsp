            ...
            jump: function(e){ //触发分页后的回调
                $.get('/getCourseByPage', {page: e.curr,
                    ...
                    for(var i = 0; i < res.rows.length; i++) {
                        ...
                        htmlStr += "<td class='t2'><div><a href='/household/courseInfo?id=" + item.id + "'>【" + item.teacher.name.substr(0,1) + "老师】" + item.title + "</a><br><div>" + item.detailExplain + "<br>" + displayTeacherShenfen(item.teacher);
